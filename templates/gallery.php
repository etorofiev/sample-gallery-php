            ...
            <div class="posts">
                ...
                <section class="post">
                    ...
                    <div class="post-description">
                        <p>
                            Here you can browse all the available images and view information about them.
                        </p>
                    </div>
                    <form class="pure-form" method="post" action="search">
                        <fieldset>
                            <legend>Search for images by name or description</legend>

                            <input type="text" name="search_term" placeholder="Search for something">
